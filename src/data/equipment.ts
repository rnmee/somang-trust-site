...
export const monitors: Gear[] = [
  ...
  {
    role: "On backorder — indoor PM2.5 only",
    pick: "PurpleAir Flex (indoor)",
    why: "Ordered 22 August 2026; manufacturer backorder. Indoor consumer PM2.5 (Plantower). Not an outdoor weather station, not a wildfire-network node, and not an ISO 14644 instrument. It cannot count 0.5 µm particles to Class 8. Default cloud upload to PurpleAir. Do not use it as the warranty or cleanliness record.",
    est: "On backorder (ordered 22 Aug 2026)",
