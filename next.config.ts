...
const nextConfig: NextConfig = {
  ...
  async rewrites() {
    return [
      ...
      { source: "/corps/kimi", destination: "/corps-llama.html" },
      { source: "/corps/solar", destination: "/corps-iljimae.html" },
      { source: "/corps/iljimae", destination: "/corps-iljimae.html" },
      { source: "/corps/mistral", destination: "/corps-llama.html" },
      { source: "/corps/jinshi", destination: "/corps-chatgpt.html" },
      { source: "/corps/assistant-grit", destination: "/corps-gemini.html" },
      { source: "/corps/lantern", destination: "/corps-qwen.html" },
      { source: "/corps/field", destination: "/corps-iljimae.html" },
      { source: "/corps/alchemist", destination: "/corps-cursor.html" },
      { source: "/corps/unit-12", destination: "/corps-grok.html" },
      { source: "/corps-mistral", destination: "/corps-llama.html" },
      { source: "/corps/:slug", destination: "/corps-:slug.html" },
